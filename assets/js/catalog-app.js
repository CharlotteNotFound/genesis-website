  ...
  if (projectGrid) {
    ...
    projectGrid.innerHTML = projects.slice(0, limit).map((project, index) => caseStudies ? `<article class="project-case reveal">
      <div class="project-case__overview">
        <div class="project-case__story"><p class="eyebrow">Featured ${String(index + 1).padStart(2, "0")} · ${project.type}</p><h2>${project.title}</h2><div class="project-case__narrative"><p>${project.description}</p><p>${project.productNote}</p></div></div>
